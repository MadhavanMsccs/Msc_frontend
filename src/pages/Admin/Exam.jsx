...
const Exam = () => {
  ...
  const classesWithSubjects = {
    ...
    I_MBA:['Accounting and Finance','Sales Management','Marketing Management'],
    II_MBA:['Design Thinking - I','Design Thinking - II','Strategic Management'],
  ...
  const fetchExams = async () => {
    try {
      const response = await axios.get('https://msc-backend-3.onrender.com/api/v1/exam/getall');
  ...
  const handleAddExam = async (e) => {
    ...
    try {
      const response = await axios.post('https://msc-backend-3.onrender.com/api/v1/exam', newExam);
  ...
  const handleDeleteExam = async (id) => {
    try {
      await axios.delete(`https://msc-backend-3.onrender.com/api/v1/exam/${id}`);
