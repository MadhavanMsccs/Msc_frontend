...
const Classes = () => {
  ...
  const fetchClasses = async () => {
    setLoading(true);
    try {
      const response = await axios.get('https://msc-backend-3.onrender.com/api/v1/class/getall');
  ...
  const handleAddClass = async (e) => {
    ...
    if (newClassName.trim() !== '') {
      ...
      try {
        const response = await axios.post('https://msc-backend-3.onrender.com/api/v1/class', { grade: newClassName });
  ...
  const handleDeleteClass = async (id) => {
    try {
      await axios.delete(`https://msc-backend-3.onrender.com/api/v1/class/${id}`);
