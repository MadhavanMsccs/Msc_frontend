...
import { BsGraphUp, BsFileText, BsBook, BsGraphDown, BsCalendar, BsChatDots} from 'react-icons/bs';
  ...
  return (
    <SidebarContainer style={{ width: isOpen ? '250px' : '80px' }}>
      ...
      <SidebarNav>
        ...
        <SidebarNavItem>
          <SidebarIcon><BsBook /></SidebarIcon>
          <StyledLink to="/student/fees">Fees</StyledLink>
        </SidebarNavItem>
        <SidebarNavItem>
        ...
        <SidebarNavItem>
          ...
          <StyledLink to="/eventconducted">Images</StyledLink>
        </SidebarNavItem>
        <SidebarNavItem>
        <SidebarIcon><BsBook /></SidebarIcon>
