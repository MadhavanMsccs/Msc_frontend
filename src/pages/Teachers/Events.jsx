...
const EventCalendar = () => {
  ...
  const addEvent = async (e) => {
    ...
    try {
      const response = await axios.post('https://msc-backend-3.onrender.com/api/v1/events', { event: newEvent, date: eventDate });
  ...
  const deleteEvent = async (id) => {
    try {
      await axios.delete(`https://msc-backend-3.onrender.com/api/v1/events/${id}`);
