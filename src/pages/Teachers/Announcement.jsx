...
const CheckAnnouncementSection = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post('https://msc-backend-3.onrender.com/api/v1/announcements', {
  ...
  const deleteAnnouncement = async (id) => {
    try {
      await axios.delete(`https://msc-backend-3.onrender.com/api/v1/announcements/${id}`);
